    ...
    public void evoluciona() {
        ...
        for(int i=0; i<=29; i++){
            for(int j=i; j<=79-i; j++){
                switch(j%12){
                    case 0:
                        CopiaM[j][i]= (color%6)+2;break;
                    case 1:
                        CopiaM[j][i]= ((color+1)%6)+2;break;
                    case 2:
                        CopiaM[j][i]= ((color+2)%6)+2;break;
                    case 3:
                        CopiaM[j][i]= ((color+3)%6)+2;break;
                    case 4:
                        CopiaM[j][i]= ((color+4)%6)+2;break;
                    case 5:
                        CopiaM[j][i]= ((color+5)%6)+2;break;
                    case 6:
                        CopiaM[j][i]= ((color+5)%6)+2;break;
                    case 7:
                        CopiaM[j][i]= ((color+4)%6)+2;break;
